...
Special thanks to Anders Bendix Nielsen (Denmark), Stepan Pesterev (Russia), Carlos Mora (Ecuador) and Scott Gonzàlez (USA) for their support, feedback and help testing the software.
